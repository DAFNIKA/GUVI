...
API_KEY = "0ebcef01-70c7-4fc7-ab93-24a406b4fade"  # replace with your actual key
...
def transform_records(records):
    ...
    for rec in records:
        ...
        # Colors: colors are nested in rec['colors'], each a dict with details
...
# Sidebar classification selector and data fetch
